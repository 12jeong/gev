...
result_newton <- tryCatch( GEVnewtonRaphson_reg(x=Y, z=Z,  theta0=true_theta, expr=expr_reg, step_beta=0.1, maxiter=100), error=function(e){},  warning = function(e){})$root
...
result[[s]] <- rbind(result_newton,result_lm,result_rq) 
}

# result


# save(n,true_theta,true_beta,result,file="simulation_p2.Rdata")
