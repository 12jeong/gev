...
xyrange = c(-10,10)
nBS = 3
x1 = seq(xyrange[1],xyrange[2],length=20)
x2 = seq(xyrange[1],xyrange[2],length=20)
...
plot_ly(x =  seq(xyrange[1],xyrange[2],length=100), 
        y =  seq(xyrange[1],xyrange[2],length=100), z = fx, type="surface") %>%
...
pmat <- persp(seq(xyrange[1],xyrange[2],length=20), 
      seq(xyrange[1],xyrange[2],length=20), fx, 
      phi = 20, theta = 100, zlim=c(30,max(fx)),
      xlab="x1", ylab="x2")
mypoints <- trans3d(df_mu$x1, df_mu$x2, rep(30,ns), pmat=pmat)
points(mypoints, pch=16, col=1)
